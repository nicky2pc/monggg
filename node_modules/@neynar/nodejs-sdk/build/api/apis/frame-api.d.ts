...
export declare const FrameApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchFrameCatalog: (limit?: number, cursor?: string, timeWindow?: TrendingTimeWindow, categories?: Array<FetchFrameCatalogCategoriesEnum>, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const FrameApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchFrameCatalog(limit?: number, cursor?: string, timeWindow?: TrendingTimeWindow, categories?: Array<FetchFrameCatalogCategoriesEnum>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FrameCatalogResponse>>;
    /**
     * Fetches the mini app meta tags from the URL
     * @summary Meta tags from URL
     * @param {string} url The mini app URL to crawl
