...
export declare const MetricsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchCastMetrics: (q: string, interval?: FetchCastMetricsIntervalEnum, authorFid?: number, channelId?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const MetricsApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchCastMetrics(q: string, interval?: FetchCastMetricsIntervalEnum, authorFid?: number, channelId?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastsMetricsResponse>>;
};
/**
